      ...
      <Animated.ScrollView
        ...
        <View style={styles.detailWrapper}>
          ...
          <Text style={styles.detail}>
            You can check the origial {item.name} recipe clicking the following
            link{'\n'}
          </Text>
          <Text
            style={{
            ...
            {item.originalURL ? item.originalURL : 'This do not have '}
          </Text>
        </View>
          ...
          item.steps.map((item, index) => {
            return (
              <View style={{width: '95%', alignSelf: 'center', marginTop: 10}}>
                ...
                <Text style={styles.directionDetail}>{item}</Text>
              </View>
            );
          })
        )}
